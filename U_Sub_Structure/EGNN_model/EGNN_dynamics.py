...
from U_Sub_Structure.EGNN_model.EGNN_for_diffusion import EGNN, GNN
from U_Sub_Structure.EDM_model.utils import remove_mean, remove_mean_with_mask
import numpy as np
...
class EGNN_dynamics_QM9(nn.Module):
    def __init__(self, in_node_nf, context_node_nf,
                 ...
                 inv_sublayers=2, sin_embedding=False, normalization_factor=100, aggregation_method='mean'):
        super().__init__()
        self.mode = mode
