...
from U_Sub_Structure.EDM_model.En_diffusion import EnVariationalDiffusion
...
def get_optim(args, generative_model_1, generative_model_2):
    optim = torch.optim.AdamW(
        [{
            'params': list(generative_model_1.parametes()) + list(generative_model_2.parameters()),
            'initial_lr': args.lr}],
        amsgrad=True,
        weight_decay=1e-12)
    return optim
