...
def setup_shared_args(parser):
    ...
    parser.add_argument(
        '--sgd-restart', type=int, default=-1, metavar='int',
    ...
    # Directory to read and save data_util from
    parser.add_argument('--datadir', type=str, default='qm9/temp',
                        help='Directory to look up data_util from. (default: data_util/)')
    ...
    parser.add_argument(
        '--cutoff-type', '--cutoff', type=str, default=['learn'], nargs='*', metavar='str',
...
def setup_argparse(dataset):
    ...
    if dataset == "md17":
        parser.add_argument('--subset', '--molecule', type=str, default='',
                            help='Subset/molecule on data_util with subsets (such as md17).')
    elif dataset == "qm9":
...
# how-can-i-require-my-python-scripts-argument-to-be-a-float-between-0-0-1-0-usin
class Range(object):
