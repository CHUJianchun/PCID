...
from U_Chem.data_util.prepare.md17 import download_dataset_md17
from U_Chem.data_util.prepare.qm9 import download_dataset_qm9
...
def prepare_dataset(datadir, dataset, subset=None, splits=None, cleanup=True, force_download=False):
    ...
    ----------
    datadir : str
        Path to the directory where the data_util and calculations and is, or will be, stored.
    dataset : str
    ...
    cleanup : bool, optional
        Clean up files created while preparing the data_util.
    ...
    datafiles : dict of strings
        Dictionary of strings pointing to the files containing the data_util.
    ...
    # Assume one data_util file for each split
