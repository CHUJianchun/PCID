...
from U_Chem.data_util.dataset_class import ProcessedDataset
from U_Chem.data_util.prepare.download import prepare_dataset
...
def initialize_datasets(args, datadir, dataset, subset=None, splits=None,
    ...
    # Now initialize MolecularDataset based upon loaded data_util
...
def _get_species(datasets, ignore_check=False):
    ...
    all_species : Pytorch tensor
        List of all species present in the data_util.  Species labels shoguld be integers.
