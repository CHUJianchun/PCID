...
def create_folders(args):
    """
    try:
        os.makedirs('ZDataD_Molecules/' + args.exp_name)
    except (OSError, FileExistsError):
        pass
    """
    try:
        if args.ion is not None:
            os.makedirs('ZDataC_SavedModel/%s/%s' % (args.exp_name, args.ion))
        else:
            os.makedirs('ZDataC_SavedModel/%s' % args.exp_name)
    except (OSError, FileExistsError):
        pass
...
# Rotation data_util augmntation
